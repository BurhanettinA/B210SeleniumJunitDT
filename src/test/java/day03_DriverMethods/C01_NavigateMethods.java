...
public class C01_NavigateMethods {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.navigate().to("https://www.amazon.com");//driver.get() methodu ile ayni isi yapar
        Thread.sleep(3000);

        //Tekrar techproeducation sayfasina donelim
        driver.navigate().back();//sayfada geri donme islemi yapar  <-
        Thread.sleep(3000);

        //Yeniden Amazon sayfasina gidelim
        driver.navigate().forward();//sayfada ileri gitme islemi yapar ->
        Thread.sleep(3000);
